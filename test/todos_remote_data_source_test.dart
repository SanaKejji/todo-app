  ...
  group(
    ...
    () {
      ...
      test('fetch success', () async {
        ...
        final response = await mostPopularRemote.getMostPopular(MostPopularParams());
  ...
  "results": [
    {
      ...
      "type": "Article",
      "title": "Videos Show Police Officer Fatally Shooting Black Man in Michigan",
      "abstract":
      ...
      "des_facet": ["Police Brutality, Misconduct and Shootings", "Black People"],
      "org_facet": [],
