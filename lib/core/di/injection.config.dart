...
import 'package:todo_app/core/di/injection_module.dart' as _i27;
import 'package:todo_app/core/services/auth_storage_service.dart' as _i7;
import 'package:todo_app/core/services/todos_storage_service.dart' as _i8;
...
import 'package:todo_app/domain/use_cases/todos/update_todo_use_case.dart'
    as _i17;
import 'package:todo_app/presentation/auth/bloc/auth_bloc.dart' as _i26;
import 'package:todo_app/presentation/base/bloc/base_cubit.dart' as _i25;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i8.TodosStorageService>(
        () => _i8.TodosStorageService(gh<_i3.SharedPreferences>()));
    ...
    gh.lazySingleton<_i25.BaseCubit>(
        () => _i25.BaseCubit(gh<_i22.GetCurrentUserUseCase>()));
    gh.factory<_i26.AuthBloc>(() => _i26.AuthBloc(gh<_i23.LoginUseCase>()));
    return this;
  }
}
